...
- [Download VNIR Dataset]( https://mega.nz/file/XHoQmQoQ#u-80Y_MPzT1Wu7jb-fXGS0XzTWP8wd45P6eIurH0Yfw )
...
- Then, each image is divided into four quadrants for data augmentation.
- Two 100-W halogen light sources are used by positioning at the left side of SWIR and right side of RGB to ensure homogeneous light distribution.
- [Download SWIR Dataset]( https://mega.nz/file/maxWgaIT#k-3osHtZZ4nMMlCBiicnwzQJ2jIgEG8QmzCJHhUgJx8 )
## RGB Wheat Dataset
...
- Then, each image is divided into four quadrants for data augmentation.
- Two 100-W halogen light sources are used by positioning at the left side of SWIR and right side of RGB to ensure homogeneous light distribution.
- [Download RGB Dataset]( https://mega.nz/file/jXIDhaLQ#qXgu6cjcd-Izs7vUu0w7Jm5jQGPZ7g2ZZaOp_RSIweA )
## Results
